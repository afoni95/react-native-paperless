...
interface NonSearchableDropdownItem {
  id: number;
  name: string;
}

interface NonSearchableDropdownProps {
  items: NonSearchableDropdownItem[];
...
export const NonSearchableDropdown: React.FC<NonSearchableDropdownProps> = ({
  items,
  selectedId,
  onSelect,
  placeholder,
